...
dump_debug_item_t aml_debug_items[AML_DEBUG_DUMP_MAX] = {
    ...
    {AML_DEBUG_AUDIOHAL_SPEED,          AML_DEBUG_AUDIOHAL_SPEED_PROPERTY,                 0},    //AML_DEBUG_AUDIOHAL_SPEED
    {AML_DEBUG_AUDIOHAL_VOLUME_SHAPER,  AML_DEBUG_AUDIOHAL_VOLUME_SHAPER_PROPERTY,         0},    //AML_DEBUG_AUDIOHAL_VOLUME_SHAPER
    {AML_DEBUG_AUDIOHAL_DETECT_ZERO_DATA,  AML_DEBUG_AUDIOHAL_DETECT_ZERO_DATA_PROPERTY,   0},    //AML_DEBUG_AUDIOHAL_DETECT_ZERO_DATA
    ...
    {AML_DUMP_AUDIOHAL_AIAUDIO,         AML_DUMP_AUDIOHAL_AIAUDIO_PROPERTY,                0},    //AML_DUMP_AUDIOHAL_AIAUDIO
};
