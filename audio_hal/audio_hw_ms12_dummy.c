...
void set_ms12_ad_mixing_enable(struct audio_stream_out *stream __unused, int ad_mixing_enable __unused)
{
    return;
}

void set_ms12_ad_mixing_level(struct audio_stream_out *stream __unused, int mixing_level __unused)
{
    return;
}

void set_ms12_ad_vol(struct audio_stream_out *stream __unused, int ad_vol __unused)
{
    return;
}
...
void set_ms12_ac4_presentation_group_index(struct audio_stream_out *stream __unused, int index __unused)
{
    return;
}

void set_ms12_ac4_1st_preferred_language_code(struct audio_stream_out *stream __unused, char *lang_iso639_code __unused)
{
    return;
}

void set_ms12_ac4_2nd_preferred_language_code(struct audio_stream_out *stream __unused, char *lang_iso639_code __unused)
{
    return;
}

void set_ms12_ac4_prefer_presentation_selection_by_associated_type_over_language(struct audio_stream_out *stream __unused, int prefer_selection_type __unused)
{
    return;
}

void set_ms12_ac4_short_prog_identifier(struct audio_stream_out *stream __unused, int short_program_identifier __unused)
{
    return;
}

void set_ms12_ac4_preferred_associated_type(struct audio_stream_out *stream __unused, int associated_type __unused)
{
    return;
}

void set_ms12_ac4_dialogue_enhancement(struct audio_stream_out *stream __unused, int ac4_de __unused)
{
    return;
}

void set_ms12_content_volume_leveler(struct audio_stream_out *stream __unused, int* volume_leveler __unused)
{
    return;
}

void set_ms12_content_dialogue_enhancer(struct audio_stream_out *stream __unused, int* content_de __unused)
{
    return;
}
...
void set_dolby_ms12_drc_parameters(audio_format_t input_format __unused, int output_config_mask __unused, struct dolby_ms12_desc *ms12 __unused)
{
    return;
}
...
int dolby_ms12_get_latency(struct dolby_ms12_desc *ms12 __unused, audio_format_t output_format __unused)
{
    return 0;
}
