...
#define AML_HWSYNC_STREAM_TIMER_NOMS12_RENDER_DELAY (100)
#define AML_HWSYNC_STREAM_TIMER_NOMS12_PAUSE_RENDER_DELAY (160)
#define AML_HWSYNC_STREAM_TIMER_RENDER_DELAY (100)
#define AML_HWSYNC_STREAM_TIMER_RENDER_DELAY2 (300)
